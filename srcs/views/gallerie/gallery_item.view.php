<div class="gallerie_item">
	...
	<form class="comment_form">
		<input type="text" class="comment_input" placeholder="Add a comment..."/>
...
function likePublication(publication_id)
{
	let ajax = new Ajax();
	ajax.post(`/publications/${publication_id}/like`, {});
}
